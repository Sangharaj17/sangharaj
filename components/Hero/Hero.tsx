...
function Hero() {
    return (
        <div className='ml-12 w-full flex items-center p-10 pt-20'>
            <div className='flex flex-col pl-10 gap-6 w-1/2 '>
                <h1 className='font-bold text-5xl'>Hi, I Am <br /> Sangharaj Jadhav</h1>
                ...
                <div className='flex w-full items-center gap-8'>
                    <Link href='' className='text-lg bg-blue-600 text-white p-4 px-6 rounded-lg'>
                        About me
                    </Link>
                    <Link href='' className='text-lg p-4 border rounded-lg'>
                        Projects
                    </Link>
                </div>
